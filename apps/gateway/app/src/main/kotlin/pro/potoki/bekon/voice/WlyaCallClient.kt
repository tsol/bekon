...
class WlyaCallClient(
    ...
    private val http = OkHttpClient.Builder()
        ...
        // PCM already fills the socket; protocol pings queue behind it and
        // trip "didn't receive pong within 20000ms" after a few successes.
    ...
    fun connect(url: String, seed: String, room: String, clientId: String) {
        ...
        socket = http.newWebSocket(req, object : WebSocketListener() {
            ...
            override fun onMessage(webSocket: WebSocket, bytes: ByteString) {
                ...
                VoiceMeters.noteWsIn(pcm)
                try {
                    onPcm(pcm)
                } catch (e: Exception) {
                    // A phone audio endpoint may disappear during call teardown.
                    // Audio callback failures must not terminate the WebSocket.
    ...
    /** Invalidate listeners and abort the current socket. Returns the new generation. */
